	...
	<div class="content-wrapper">
		...
		<!--↓↓↓↓↓↓↓CONTENIDO-DE-PAGINA↓↓↓↓↓↓↓↓-->
					...
					<div class="box-body">
						...
						<?php echo form_open('admin/Admin_controller/alta_usuario?prm=4');?>
						...
						<div class="row">
								...
								<div class="col-md-4">
												...
												<input type="text" value="<?php echo set_value('nombre');?>" class="form-control input-sm" name="nombre" id="nombre" onChange="javascript:this.value=this.value.toUpperCase();"/>
								...
								<div class="col-md-4">
												...
												<input type="text" value="<?php echo set_value('paterno');?>" class="form-control input-sm" name="paterno" id="paterno" onChange="javascript:this.value=this.value.toUpperCase();"/>
								...
								<div class="col-md-4">
												...
												<input type="text" value="<?php echo set_value('materno');?>" class="form-control input-sm" name="materno" id="materno" onChange="javascript:this.value=this.value.toUpperCase();"/>
						...
						<!-- columna -->
								<div class="col-md-3">
												...
												<input type="text" value="<?php  echo set_value('username');?>" class="form-control input-sm" name="username" id="username"/>
								...
								<div class="col-md-3">
												<div class="form-group <?php if(form_error('password')){echo'has-error';} ?>">
														...
														<input type="password" value="<?php  echo set_value('password');?>" class="form-control input-sm" name="password" id="password"/>                            
								...
								<div class="col-md-3">
												...
												<input type="text" value="<?php  echo set_value('telefono');?>" class="form-control input-sm" name="telefono" id="telefono"/>
								...
								<div class="col-md-3">
										...
										<select name="idRol" id="idRol"  class="select2 form-control">
											...
											<option value="<?php echo $rol->idRol;?>" <?php echo set_select('idRol', $rol->idRol); ?>><?php echo $rol->rol?>   
											</option>
											<?php endforeach;?>
										</select>
						...
						<div class="row">
							 <!-- columna -->
								<div class="col-md-6">
										...
										<input type="text" value="<?php echo set_value('email');?>" class="form-control input-sm" name="email" id="email" />
								...
								<div class="col-md-6">
										...
										<select name="idArea" id="idArea"  class="select2 form-control">
											...
											<option value="<?php echo $area->idArea;?>" <?php echo set_select('idArea', $area->idArea); ?>><?php echo $area->area?>   
											</option>
											<?php endforeach;?>
										</select>
						...
						<div class="col-md-4">
								...
								<div class="col-md-4">
											...
											<label>
												<input type="radio" value="1"   class="flat-red" name="estado">
												Activo
											</label>
											&nbsp;
											&nbsp;
											...
											<label>
												<input type="radio"  checked  value="0" class="flat-red" name="estado">
												Inactivo
											</label>
								</div>
							 <div class="col-md-4">
