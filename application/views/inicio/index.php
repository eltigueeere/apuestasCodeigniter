...
<section class="b-infoblock">
    <div class="container">
        <h2 class="f-primary-b f-center">Apuesta ahora</h2>
        <p class="f-center c-s-62 f-title-small">Estas son las proximas apuestas. </p>
...
<div class="b-bg-video_cont video-color-overlay">
    ...
    <div class="b-bg-video__play_title f-bg-video__play_title f-primary-l">Todas las peleas de gallos de pais</div>
    <div class="container b-bg-video__play_text-wrap">
        <div class="b-bg-video__play_text f-bg-video__play_text f-primary-b"><i class="b-bg-dotted"></i><span>F2F</span><i class="b-bg-dotted"></i></div>
        <div class="b-bg-video__numbers row j-number-up-wrap">
            ...
            <div class="col-sm-3">
                <div class="b-bg-video__numbers_item f-bg-video__numbers_item">
                    ...
                    <div class="b-bg-video__numbers_item_hint f-bg-video__numbers_item_hint f-primary-l">Cantidad de videos</div>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="b-bg-video__numbers_item f-bg-video__numbers_item">
                    <div class="b-bg-video__numbers_item_n f-bg-video__numbers_item_n f-primary-b j-number-up">2356</div>
                    <div class="b-bg-video__numbers_item_hint f-bg-video__numbers_item_hint f-primary-l">Horas de video</div>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="b-bg-video__numbers_item f-bg-video__numbers_item">
                    <div class="b-bg-video__numbers_item_n f-bg-video__numbers_item_n f-primary-b j-number-up">7238</div>
                    <div class="b-bg-video__numbers_item_hint f-bg-video__numbers_item_hint f-primary-l">Volumen de apuestas</div>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="b-bg-video__numbers_item f-bg-video__numbers_item">
                    <div class="b-bg-video__numbers_item_n f-bg-video__numbers_item_n f-primary-b j-number-up">5</div>
                    <div class="b-bg-video__numbers_item_hint f-bg-video__numbers_item_hint f-primary-l">Se unieron este dia</div>
                </div>
            </div>
        </div>
    </div>
