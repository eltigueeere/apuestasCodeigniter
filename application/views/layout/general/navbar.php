<header>
  <div class="container b-header__box b-relative">
    <a href="<?php echo base_url(); ?>" class="b-left b-logo "><img class="color-theme" data-retina src="<?php echo base_url('recursos/front1/'); ?>img/logo-header-default.png" alt="Logo" /></a>
        ...
        <li>
            <div class="b-option-cart__items__img">
                <div class="view view-sixth">
                    <img data-retina="" src="<?php echo base_url('recursos/front1/'); ?>img/shop/cart_mini_pic.jpg" alt="">
    ...
    <li class="b-top-nav__1level f-top-nav__1level is-active-top-nav__1level f-primary-b"><a href="<?php echo base_url(); ?>"><i class="fa fa-home b-menu-1level-ico"></i>Inicio <span class="b-ico-dropdown"><i class="fa fa-arrow-circle-down"></i></span></a>
    ...
    <li class="b-top-nav__1level f-top-nav__1level f-primary-b">
        <a href="<?php echo base_url('/Home/galeria'); ?>"><i class="fa fa-picture-o b-menu-1level-ico"></i>Galeria <span class="b-ico-dropdown"><i class="fa fa-arrow-circle-down"></i></span></a>
        <div class="b-top-nav__dropdomn">
            <ul class="b-top-nav__2level_wrap">
                <li class="b-top-nav__2level_title f-top-nav__2level_title">Ferias</li>
                <li class="b-top-nav__2level f-top-nav__2level f-primary"><a href="<?php echo base_url('/Home/galeria'); ?>"><i class="fa fa-angle-right"></i>Lo mejor</a></li>
                <li data-box-id="0" class="b-top-nav__2level f-top-nav__2level f-primary b-top-nav__with-multi-lvl"><a onclick="return false" href=""><i class="fa fa-angle-right"></i>Feria 1</a>
                    <ul id="0" class="b-top-nav__multi-lvl-box">
                        <li class="b-top-nav__multi-lvl"><a href="portfolio_our_portfolio_1_colums.html"><i class="fa fa-angle-right"></i>Año 2020</a></li>
                        <li class="b-top-nav__multi-lvl"><a href="portfolio_our_portfolio_1_colums_v2.html"><i class="fa fa-angle-right"></i>Año2020</a></li>
                    </ul>
                </li>
                <li data-box-id="1" class="b-top-nav__2level f-top-nav__2level f-primary b-top-nav__with-multi-lvl"><a onclick="return false" href=""><i class="fa fa-angle-right"></i>Feria 2</a>
                    <ul id="1" class="b-top-nav__multi-lvl-box">
                        <li class="b-top-nav__multi-lvl"><a href="portfolio_our_portfolio_2_colums.html"><i class="fa fa-angle-right"></i>Año 2019</a></li>
                        <li class="b-top-nav__multi-lvl"><a href="portfolio_our_portfolio_2_colums_v2.html"><i class="fa fa-angle-right"></i>Año 2020</a></li>
                    </ul>
                </li>
    ...
    <li class="b-top-nav__1level f-top-nav__1level f-primary-b">
        <a href="<?php echo base_url('/Home/nuestrosPrecios'); ?>"><i class="fa fa-code b-menu-1level-ico"></i>Nuestros precios <span class="b-ico-dropdown"><i class="fa fa-arrow-circle-down"></i></span></a>
        <!--<div class="b-top-nav__dropdomn">
            <ul class="b-top-nav__2level_wrap">
    ...
    <li class="b-top-nav__1level f-top-nav__1level f-primary-b b-top-nav-big">
        <a href="<?php echo base_url('/Home/nosotros'); ?>"><i class="fa fa-cloud-download b-menu-1level-ico"></i>Nosotros<span class="b-ico-dropdown"><i class="fa fa-arrow-circle-down"></i></span></a>
        <!--<div class="b-top-nav__dropdomn">
            <ul class="b-top-nav__2level_wrap">
    ...
    <li class="b-top-nav__1level f-top-nav__1level f-primary-b"> <!-- b-top-nav-big -->
        <a href="<?php echo base_url('/Auth/inicio'); ?>"><i class="fa fa-inbox b-menu-1level-ico"></i>Iniciar sesión <span class="b-ico-dropdown"><i class="fa fa-arrow-circle-down"></i></span></a>
        <div class="b-top-nav__dropdomn">
            <ul class="b-top-nav__2level_wrap">
                <li class="b-top-nav__2level f-top-nav__2level f-primary"><a href="<?php echo base_url('/Auth/inicio'); ?>"><i class="fa fa-angle-right"></i>Entrar</a></li>
                <li class="b-top-nav__2level f-top-nav__2level f-primary"><a href="<?php echo base_url('/Auth/crearCuenta'); ?>"><i class="fa fa-angle-right"></i>Crear cuenta</a></li>
    ...
    <li class="b-top-nav__1level f-top-nav__1level f-primary-b">
        <a href="<?php echo base_url('recursos/front1/'); ?>contact_us.html"><i class="fa fa-folder-open b-menu-1level-ico"></i>Contact us<span class="b-ico-dropdown"><i class="fa fa-arrow-circle-down"></i></span></a>
        <div class="b-top-nav__dropdomn">
            <ul class="b-top-nav__2level_wrap">
                <li class="b-top-nav__2level_title f-top-nav__2level_title">Contact us</li>
                <li class="b-top-nav__2level f-top-nav__2level f-primary"><a href="<?php echo base_url('recursos/front1/'); ?>contact_us.html"><i class="fa fa-angle-right"></i>Version1</a></li>
                <li class="b-top-nav__2level f-top-nav__2level f-primary"><a href="<?php echo base_url('recursos/front1/'); ?>contact_us_v2.html"><i class="fa fa-angle-right"></i>Version2</a></li>
            </ul>
        </div>
    </li>
    <li class="b-top-nav__1level f-top-nav__1level f-primary-b b-top-nav-big">
